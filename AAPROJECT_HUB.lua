...
local function createLoadingScreen()
    ...
    -- Título "SibahHub" com efeito brilhante
    ...
    userText.Text = "Welcome: "..lp.Name.." ("..tostring(lp.AccountAge).." dias)"
    ...
    heartbeatConnection = RunService.Heartbeat:Connect(function()
        ...
        if finished then
            ...
            fadeTween.Completed:Connect(function()
                ...
                game:GetService("ReplicatedStorage").RE["1RPNam1eTex1t"]:FireServer(table.unpack({
                    [1] = "RolePlayBio",
                    [2] = "RegzyyHub | by: sibah_txt",
                }))
                
                -- Exibe a notificação de boas-vindas
                StarterGui:SetCore("SendNotification", {
                    Title = "RegzyyHub",
                    Text = "Welcome To RegzyyHub!",
                    Duration = 4
                })
...
local Window = Libary:MakeWindow({
    Title = "RegzyyHub | Brookhaven RP ",
    SubTitle = "by Sibah with xAi",
    LoadText = "Loading RegzyyHub",
    Flags = "RegzyyHub_Broookhaven"
})
Window:AddMinimizeButton({
    Button = { Image = "rbxassetid://6319951718", BackgroundTransparency = 0 },
...
InfoTab:AddParagraph({ "Owner / Developer:", "Sibah" })
InfoTab:AddParagraph({ "You are using:", "RegzyyHub Brookhaven " })
